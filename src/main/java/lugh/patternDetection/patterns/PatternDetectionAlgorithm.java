package lugh.patternDetection.patterns;

import lugh.patternDetection.parser.ClassObject;
...
/**
 * Basic algorithm class. Its function DetectPattern(Pattern p) is responsible for detecting lugh.patternDetection.patterns over the given
...
public class PatternDetectionAlgorithm {
    ...
    /**
     * Detects PatternCandidates and returns the results in a String. Used mainly for lugh.patternDetection.gui purposes.
     *
