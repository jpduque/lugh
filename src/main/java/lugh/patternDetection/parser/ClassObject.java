...
public class ClassObject {
	 ...
	 * use connections are saved in both a static arraylist containing all use connections(lugh.patternDetection.parser.ProjectASTParser.Uses)
	 ...
	 * connections(lugh.patternDetection.parser.ProjectASTParser.Inherits)
	 ...
	 * A total parsing is required before this function is called, so that the static Hashmap Classes is filled.
	 * has connections are saved in both a static arraylist containing all has connections(lugh.patternDetection.parser.ProjectASTParser.Has)
	 ...
	 * connections(lugh.patternDetection.parser.ProjectASTParser.Calls)
	 ...
	 * connections(lugh.patternDetection.parser.ProjectASTParser.Creates)
	 ...
	 * connections(lugh.patternDetection.parser.ProjectASTParser.References)
