package lugh.pattern_detection.parser;
...
/**
 * Represents a class. This is the lugh.Main object of this project.
 * 
 */
public class ClassObject {
	 ...
	 * use connections are saved in both a static arraylist containing all use connections(lugh.pattern_detection.parser.ProjectASTParser.Uses)
	 ...
	 * connections(lugh.pattern_detection.parser.ProjectASTParser.Inherits)
	 ...
	 * A total parsing is required before this function is called, so that the static Hashmap Classes is filled.
	 * has connections are saved in both a static arraylist containing all has connections(lugh.pattern_detection.parser.ProjectASTParser.Has)
	 ...
	 * connections(lugh.pattern_detection.parser.ProjectASTParser.Calls)
	 ...
	 * connections(lugh.pattern_detection.parser.ProjectASTParser.Creates)
	 ...
	 * connections(lugh.pattern_detection.parser.ProjectASTParser.References)
